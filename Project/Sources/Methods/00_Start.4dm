...
Case of 
	...
	Else 
		...
		$options.title:="Enable and use data change tracking"
		
		$options.blog:="blog.4d.com"
		$options.info:="4D Stamp"  //ex : "4D View Pro feature"
		
		$options.minimumVersion:="2004"  // 1660 means 16R6   1601 means 16.1 (do not use !)
